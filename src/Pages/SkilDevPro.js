            ...
            <div className={styles.main_neet_rep_flex}>
                <div className={styles.main_neet_rep_left_div}>
                    <div className={styles.main_neet_rep_left_div_text}>
                        ...
                        <p>&emsp;The benefits of Skill Development include improved performance, improved accuracy & quality, improved communication, compliance with rules & regulations, improved recruitment & career opportunities, and development of good customer relations.</p>
                    </div>
                </div>
