  ...
  return (
    <>
        ...
        <div className={styles.main_neet_rep}>
            <div className={styles.main_neet_rep_flex} style={{paddingBottom:'5rem',paddingTop:'2rem'}}>
